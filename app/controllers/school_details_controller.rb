class SchoolDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @school_detail.save
        format.html { redirect_to school_detail_url(@school_detail), notice: "School detail was successfully created." }
  ...
  def update
    respond_to do |format|
      if @school_detail.update(school_detail_params)
        format.html { redirect_to school_detail_url(@school_detail), notice: "School detail was successfully updated." }
  ...
  private
    ...
    def school_detail_params
      params.require(:school_detail).permit(:teacher, :school, :school_year)
    end
end
